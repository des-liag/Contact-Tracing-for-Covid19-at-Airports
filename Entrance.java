...
public class Entrance extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Label user = new Label("Please if you are a regular user select the button USER" );
        Label admin = new Label("Please if you are the administrator of the app, select the button ADMINISTRATOR. ");
